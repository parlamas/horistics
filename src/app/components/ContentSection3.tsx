// src/app/components/ContentSection3.tsx
...
const ContentSection3: React.FC<ContentSectionProps> = ({ language, isRTL }) => {
  ...
  const content: Record<Language, JSX.Element> = {
    en: (
      <div style={{ marginTop: '-30px', width: '80%', margin: '0 auto' }}>
        ...
        <p>The Present Perfect Continuous, as all perfect continuous tenses, always refers, either implicitly or explicity, to <span style={{ color:'red', fontWeight:'bold' }}>duration</span>. <span style={{ color:'blue', fontWeight:'bold' }}>I have been working in the garden (for some time now/for 2 hours/for 2 months</span>) etc. This is true for statements, questions as well as negations.</p>
        <p>What triggers questions in the Present Perfect Continuous tense is always something that comes to the attention of the person who asks the question. Questions or comments that make use of the Present Perfect Continuous beg for <span style={{ color:'red', fontWeight:'bold' }}>justification.</span> For example, I notice that your eyes are red because of lack of sleep, so I remark: <span style={{ color:'blue', fontWeight:'bold' }}>You have not been sleeping much (lately).</span>  Your grades at school are unacceptable, so your father remarks, <span style={{ color:'blue', fontWeight:'bold' }}>It is evident that you have not been studying (for the last few months).</span></p>
        <p>So, key words to remember: <b>duration</b> and <b>justification</b>.</p>
      </div>
    ),
